 ...
 * `size` (number) 一個 prop**,沒有 variant、沒有 state、沒有 color(用 currentColor
 * 從父層繼承)。因此本 spec 只有 Overview + 消費場景兩類 story——沒有 StateMatrix
 * (spinner 本身就是單一狀態:旋轉);沒有獨立 ColorMatrix(色彩完全 inherit)。
 * 完整設計規則見 `spinner.spec.md`。
 */
